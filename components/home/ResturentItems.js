...
export const localRestaurants = [
  {
    name: "مستوحى من عطر: ديور سوفاج مزيج حار ومتوهج .",
    image_url:
...
// ///////////////////////////////// Main Function/////////////////////////////////////////
export default function ResturentItems({ navigation, ...props }) {
  return (
    <>
      {props.restaurantData.map((restaurant, index) => (
        ...
        >
          <View style={{ marginTop: 10, padding: 15, backgroundColor: "#fff" }}>
            ...
            <ProductTitle title={restaurant.name} rating={restaurant.rating} />
          </View>
        </TouchableOpacity>
      ))}
    </>
